...
def register():
  # Register a handler with any of bpy.app.handlers
  # in https://docs.blender.org/api/current/bpy.app.handlers.html
  pass

def unregister():
  # Unregister a handler with any of bpy.app.handlers
  pass
